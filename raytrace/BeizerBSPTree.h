...
class BeizerBSPTree : public Object
{
private:
	void init();
	...
	bool RayTreeIntersect(Ray input_ray, BeizerBSPTree_Node* tree_node, double& t, double& t_surface, double& theta_surface);          //最终的t是最近交点的参数,t_surface为在曲面上的参数,theta为曲面角度的参数
...
public:
	...
	const int divide = 4096;           //根据参数将beizer曲线（以及旋转）划分为多少块
